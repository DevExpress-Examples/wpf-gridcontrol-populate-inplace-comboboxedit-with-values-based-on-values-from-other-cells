...
Namespace FilterCombo
    ...
    Friend Class MainViewModel
        ...
        Public Sub New()
            ...
            Cars.Add(New Car() With {.Color = "Red", .FilterType = RowFilterType.Type1})
            Cars.Add(New Car() With {.Color = "Azure", .FilterType = RowFilterType.Type2})
            Cars.Add(New Car() With {.Color = "Blue", .FilterType = RowFilterType.Type1})
            ComboItems = New ObservableCollection(Of ComboItem)()
            ComboItems.Add(New ComboItem() With {.Color = "Red", .FilterType = RowFilterType.Type1})
            ComboItems.Add(New ComboItem() With {.Color = "Brown", .FilterType = RowFilterType.Type1})
            ComboItems.Add(New ComboItem() With {.Color = "Blue", .FilterType = RowFilterType.Type1})
            ComboItems.Add(New ComboItem() With {.Color = "Violet", .FilterType = RowFilterType.Type2})
            ComboItems.Add(New ComboItem() With {.Color = "Azure", .FilterType = RowFilterType.Type2})
        End Sub
